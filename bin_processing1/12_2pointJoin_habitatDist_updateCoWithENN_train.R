...
f1p<-read_csv("./results_train/12_1pts_Co_Mg_Sg_minDist.csv")%>%
...
# write table
write_csv(f3p,"./results_train/12_2pts_Co_Mg_Sg_minDist2.csv")

write_csv(temp,"./doc/habitat_distance_min_max_train.csv")
