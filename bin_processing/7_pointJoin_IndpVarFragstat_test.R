...
pts0<-st_read("./results_test/hab_Resil_Pts_RS.gpkg")%>%
...
# these were generated in 7_1point_create_test_test.R and then in Arcpro I used the NEAR tool to calculate distances to seagrass (sg) and mangroves (mg)
# pts<-st_read("./gis/landscape/test/test_points_fragstats.shp")%>%
#   glimpse()
# plot(pts)
...
########################333
#export table
write_csv(pts2,"./results_test/7_pts_fragstats.csv")
