...
# Reduced model with blast fishing 
# Using forward stepping model because full model with all variables would not converge

# these models have not been updated for major changes to R packages 
...
# load data 
d2<-read.csv("IndpVar_Ptse_RS.csv",header = T)
...
setwd(loc)
save(m.me_52,file="Q41_model_20161109_mixedEf1_52.R") # m23 with blast*pop #m52f from models above
save(m.me_50,file="Q41_model_20161109_mixedEf1_50.R") # m53 w/out landcape var


#save image to set options for probabilities in GT
save.image("C:/Users/Jenny/Dropbox/1PhD/R.projects/Ch4/Resilience/bin/Q41_analysis_mixedEf1_blast.RData")
